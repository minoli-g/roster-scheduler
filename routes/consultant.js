...
router.get('/roster/:wid',ifLoggedIn,isConsultant,consultantController.allRostersPage);
router.get('/roster/:wid/:y/:m',ifLoggedIn,isConsultant,consultantController.viewRoster);
